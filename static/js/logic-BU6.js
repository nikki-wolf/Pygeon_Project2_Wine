...
var subvarieties=[];
 ...
 var wineRatingData=[]
  ...
  // var subvarieties=[]
  // for (let i=0;i<countriesRating.length;i++){
  //   console.log(varietiesNonunique[i])
  //   varieties.push(varietiesNonunique[i].filter(onlyUnique));
  //   subvarieties.push(subvarietiesNonunique[i].filter(onlyUnique));
  // }
//   console.log(subvarieties);
// var flat = [
//   {"name": "wine", "Parent": null}]
// for(let i=0; i < countries.length; i++){
//   flat.push({"name": countries[i], "parent": "wine"})
//   for(let j=0; j < varieties[i].length; j++){
//       flat.push({"name": varieties[i][j], "parent": countries[i]})
//       for(let k=0; k < subvarieties[i].length; k++ ){
//           flat.push({"name": subvarieties[i][k], "parent": varieties[i][j]})
//       }
